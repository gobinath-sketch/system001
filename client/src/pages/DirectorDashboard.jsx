...
const DirectorDashboard = () => {
  ...
  const MetricCard = ({
    ...
    color
            ...
            <div className="flex items-center justify-between mb-4">
                ...
                {trend && <div className={`flex items-center text-sm ${trend === 'up' ? 'text-green-600' : 'text-red-600'}`}>
  ...
  return <div className="p-5">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                <MetricCard title="Weekly Invoice Value" value={baseMetricsUSD.weeklyInvoiceValue} icon={DollarSign} trend="up" trendValue="+12%" color="bg-blue-600" />
                <MetricCard title="Pending Receivables" value={baseMetricsUSD.pendingReceivables} icon={AlertCircle} trend="down" trendValue="-5%" color="bg-yellow-600" />
                <MetricCard title="Upcoming Payables" value={baseMetricsUSD.upcomingPayables} icon={TrendingDown} color="bg-red-600" />
                <MetricCard title="Net Cash Flow" value={baseMetricsUSD.netCashFlow} icon={TrendingUp} trend="up" trendValue="+8%" color="bg-green-600" />
            </div>
