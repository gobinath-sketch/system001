...
const OpportunityDetailPage = () => {
  ...
  const canEditDelivery = user.role === 'Delivery Head' || user.role === 'Delivery Executive' || user.role === 'Delivery Manager' || user.role === 'Super Admin';

  // Tab Visibility
  const isDeliveryRole = ['Delivery Head', 'Delivery Executive', 'Delivery Manager'].includes(user.role);
