...
const Toast = ({ id, message, type, onClose }) => {
    ...
    return (
        <div className={`flex items-start p-4 rounded-lg border shadow-lg mb-3 w-80 transform transition-all duration-300 ease-in-out animate-slide-in ${bgColors[type] || bgColors.info}`}>
