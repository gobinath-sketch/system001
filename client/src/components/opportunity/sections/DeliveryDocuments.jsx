...
const DeliveryDocuments = ({
  ...
  return <Card className="!bg-white">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                {['attendance', 'feedback', 'assessment', 'performance'].map(docType => <div key={docType} className="border border-gray-200 p-3 rounded-lg bg-gray-50 flex flex-col justify-between">
