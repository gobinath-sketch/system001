                ...
                <div>
                    ...
                    <div className="space-y-3">
                        <div>
                            ...
                            <input type="text" value={opportunity.commonDetails?.clientPONumber || 'N/A'} disabled className="w-full border p-2 rounded-lg bg-gray-100 text-gray-700 cursor-not-allowed text-sm" />
                        </div>
                        <div>
                            <label className="block text-xs font-medium text-gray-500 mb-1">PO Date</label>
                            <input type="text" value={opportunity.commonDetails?.clientPODate ? new Date(opportunity.commonDetails.clientPODate).toLocaleDateString() : 'N/A'} disabled className="w-full border p-2 rounded-lg bg-gray-100 text-gray-700 cursor-not-allowed text-sm" />
                        </div>
                        <div>
                            <label className="block text-xs font-medium text-gray-500 mb-1">PO Amount</label>
                            <div className="relative">
                                <span className="absolute left-3 top-2 text-gray-500 text-sm">₹</span>
                                <input type="text" value={opportunity.poValue ? opportunity.poValue.toLocaleString() : '0'} disabled className="w-full border p-2 pl-6 rounded-lg bg-gray-100 text-gray-700 cursor-not-allowed text-sm" />
                            </div>
                        </div>
                        <div>
