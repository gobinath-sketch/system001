  ...
  return <div className="fixed inset-0 z-50 flex items-center justify-center p-2 sm:p-4" style={{
    backgroundColor: 'rgba(0, 0, 0, 0.5)'
            ...
            <div className="bg-white rounded-lg shadow-xl w-full max-w-4xl max-h-[90vh] overflow-y-auto relative">
                ...
                <div className="p-3 sm:p-6">
                        ...
                        <div className="border-b pb-4">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="clientId" value={formData.clientId} onChange={handleClientSelect} className="w-full bg-gray-50 border-0 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue" required>
                                ...
                                {formData.clientId && <div>
                                        ...
                                        <select name="selectedContactPerson" value={formData.selectedContactPerson} onChange={handleChange} className="w-full bg-gray-50 border-0 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue">
                                ...
                                <div>
                                    ...
                                    <select name="type" value={formData.type} onChange={handleChange} className="w-full bg-gray-50 border-0 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue" required>
                  ...
                  icon: opt.value === 'Other technologies' ? <MoreHorizontal size={18} className="text-gray-500" /> : opt.icon
                }))} placeholder="Select or type technology" className="w-full bg-gray-50 border-0 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue" required />

                                        {(formData.technology === 'Emerging technologies' || formData.technology === 'Other technologies') && <div className="mt-2">
                                                <input type="text" name="customTechnology" value={formData.customTechnology} onChange={handleChange} placeholder={`Enter technology`} className="w-full bg-white border border-gray-300 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue text-sm" required />
                                            </div>}
                                    </div>
                                    <div>
                            ...
                            {formData.type === 'Vouchers' && <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div>
                                        <label className="block text-[12px] font-medium text-gray-700 mb-1">Technology *</label>
                                        <SearchableSelect name="technology" value={formData.technology} onChange={handleChange} options={getTechnologyOptions()} placeholder="Select or type technology" className="w-full bg-gray-50 border-0 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue" required />
                                    </div>
                                    <div>
                        ...
                        {formData.type !== 'Lab Support' && <div className="border-b pb-4">
                                <div className="md:col-span-2">
                                    ...
                                    <input type="text" name="requirementSummary" value={formData.requirementSummary} onChange={handleChange} className="w-full bg-gray-50 border-0 p-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue" placeholder="Brief summary of the client's requirements" required />
                                </div>
                            </div>}
