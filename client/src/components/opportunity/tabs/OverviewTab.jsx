                ...
                <div>
                    <Card className="h-full flex flex-col">
                        ...
                        {opportunity.requirementDocument && <div className="mt-4 pt-4 border-t border-gray-100">
                                ...
                                <a href={`http://localhost:5000/${opportunity.requirementDocument.replace(/\\/g, '/')}`} target="_blank" rel="noopener noreferrer" className="flex items-center text-sm text-blue-600 hover:underline bg-blue-50 p-2 rounded-lg border border-blue-100 w-fit">
