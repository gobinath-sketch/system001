...
const Tabs = ({ tabs, defaultTab, activeTab: controlledActiveTab, onChange, className = '' }) => {
    ...
    return (
        <div className={`tabs-container ${className}`}>
            ...
            <div className="flex space-x-1 border-b-2 border-gray-200 mb-6">
              ...
              ${activeTab === tab.id
                                ? 'text-primary-blue border-b-4 border-accent-yellow -mb-0.5'
                                : 'text-text-secondary hover:text-primary-blue hover:bg-gray-50'
                            }
            `}
                    >
