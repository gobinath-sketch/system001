        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 pb-4 border-b">
            <div>
              ...
              <input name="companyName" value={formData.companyName} onChange={handleChange} className="w-full h-[36px] bg-gray-50 border border-gray-200 px-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-primary-blue text-[13px]" placeholder="Enter company name" required />
            </div>
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-1">
            ...
            {formData.contactPersons.map((contact, index) => <div key={index} className="mb-6 bg-gray-50 p-4 rounded-lg border border-gray-100 relative">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-4">
                ...
                <div>
                  ...
                  <input value={contact.department} onChange={e => handleContactChange(index, 'department', e.target.value)} className="w-full h-[36px] bg-white border border-gray-200 px-3 rounded focus:outline-none focus:ring-2 focus:ring-primary-blue text-[13px]" placeholder="e.g. HR, IT" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="email" value={contact.email} onChange={e => handleContactChange(index, 'email', e.target.value)} className="w-full h-[36px] bg-white border border-gray-200 px-3 rounded focus:outline-none focus:ring-2 focus:ring-primary-blue text-[13px]" required />
                </div>
                <div>
